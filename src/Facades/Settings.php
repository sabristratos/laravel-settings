...
namespace Stratos\Settings\Facades;

use Illuminate\Support\Facades\Facade;

/**
 * @method static mixed get(string $key, mixed $default = null)
 * @method static \Stratos\Settings\Models\Setting set(string $key, mixed $value, ?string $group = null, bool $encrypted = false)
 ...
 * @method static \Stratos\Settings\Models\Setting setEncrypted(string $key, mixed $value, ?string $group = null)
 * @method static \Stratos\Settings\Managers\UserSettingsManager user($user = null)
 * @method static \Stratos\Settings\Models\Setting setWithMetadata(string $key, mixed $value, ?string $group = null, array|string|null $label = null, array|string|null $description = null, ?array $validationRules = null, ?string $inputType = null, ?bool $isPublic = null, ?int $order = null, ?array $options = null, bool $encrypted = false)
 ...
 * @method static \Stratos\Settings\Models\Setting restoreToVersion(string $key, int $historyId)
 *
 * @see \Stratos\Settings\Managers\SettingsManager
 */
